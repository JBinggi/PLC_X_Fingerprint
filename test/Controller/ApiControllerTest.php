...
use JBinggi\Fingerprint\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/fingerprint/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/fingerprint/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('fingerprint-api');
    }
}
