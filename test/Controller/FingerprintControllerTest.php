<?php
/**
 * FingerprintControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Fingerprint Module
 *
 * @category Test
 * @package Fingerprint
...
namespace OnePlaceTest\Fingerprint\Controller;

use JBinggi\Fingerprint\Controller\FingerprintController;
...
class FingerprintControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/fingerprint', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('fingerprint');
        $this->assertControllerName(FingerprintController::class); // as specified in router's controller name alias
        $this->assertControllerClass('FingerprintController');
        $this->assertMatchedRouteName('fingerprint');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/fingerprint/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('fingerprint');
        $this->assertControllerName(FingerprintController::class); // as specified in router's controller name alias
        $this->assertControllerClass('FingerprintController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/fingerprint/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('fingerprint');
        $this->assertControllerName(FingerprintController::class); // as specified in router's controller name alias
        $this->assertControllerClass('FingerprintController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/fingerprint/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('fingerprint');
        $this->assertControllerName(FingerprintController::class); // as specified in router's controller name alias
        $this->assertControllerClass('FingerprintController');
